...
//          return false; 
//       });
      $('.middle-right .icon-menu').click(function(event) {
    ...
    initLoginPopup: function() {
      ...
      $('.s-login .dropdown-toggle > a').click(function() { 
        $('.s-login .dropdown-content').toggleClass("show");
        //   $('.s-login .dropdown-content').fadeIn(100);

        return false;              
      });
      $(document).on("click", ".s-login .overlay, .close-login", function() {
        //  $('.s-login .dropdown-content').toggleClass("show");
        $('.block-content').toggleClass("show");
        return false;
      });
    ...
    initDropDownCart: function() {
      ...
      $(document).on('click', '.minicart-header .icon-remove', function(event) {
        $('.minicart-header .block-content').hide();
    ...
    initaddjs: function(){
      $(document).ready(function() {
        ...
        $('.button-more span').on('click', function (e) {
          $('.widget-dessert .widget-product__item').toggleClass('active');
        });


        $('.widget-product-list .nav-link1').hover( function (e) {
          $('.widget-product-list .nav-link').removeClass('active');
          $('.widget-product-list .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-product-list .tab-pane1').addClass('active');    
        });

        $('.widget-product-list .nav-link2').hover( function (e) {
          $('.widget-product-list .nav-link').removeClass('active');
          $('.widget-product-list .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-product-list .tab-pane2').addClass('active');      
        });

        $('.widget-product-list .nav-link3').hover( function (e) {
          $('.widget-product-list .nav-link').removeClass('active');
          $('.widget-product-list .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-product-list .tab-pane3').addClass('active');
        });

        $('.widget-product-list .nav-link4').hover( function (e) {
          $('.widget-product-list .nav-link').removeClass('active');
          $('.widget-product-list .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-product-list .tab-pane4').addClass('active');     

        }); 
        $('.widget-product-list .nav-link5').hover( function (e) {
          $('.widget-product-list .nav-link').removeClass('active');
          $('.widget-product-list .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-product-list .tab-pane5').addClass('active');  
        });




        $('.widget-testimonial .nav-link1').hover( function (e) {
          $('.widget-testimonial .nav-link').removeClass('active');
          $('.widget-testimonial .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-testimonial .tab-pane1').addClass('active');
        });

        $('.widget-testimonial .nav-link2').hover( function (e) {
          $('.widget-testimonial .nav-link').removeClass('active');
          $('.widget-testimonial .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-testimonial .tab-pane2').addClass('active');
        });

        $('.widget-testimonial .nav-link3').hover( function (e) {
          $('.widget-testimonial .nav-link').removeClass('active');
          $('.widget-testimonial .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-testimonial .tab-pane3').addClass('active');
        });

        $('.widget-testimonial .nav-link4').hover( function (e) {
          $('.widget-testimonial .nav-link').removeClass('active');
          $('.widget-testimonial .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-testimonial .tab-pane4').addClass('active');
        }); 
        $('.widget-testimonial .nav-link5').hover( function (e) {
          $('.widget-testimonial .nav-link').removeClass('active');
          $('.widget-testimonial .tab-pane').removeClass('active');
          $(this).addClass('active');
          $('.widget-testimonial .tab-pane5').addClass('active');
        });
        ...
        $('.ltabs-tabs-container .tabs-menu_btn').click(function(e){
          e.preventDefault();
          $('.ltabs-tabs-container .tabs-title').toggleClass("tabs-open");
        });
        ...
        $('.widget-testimonial .tabs-menu_btn').click(function(e){
          e.preventDefault();
          $('.widget-testimonial .tabs-title').toggleClass("tabs-open");
        });

        //product list
        $(".widget-product-list").each( function(){
          $(this).find('.tabs-title li:first-child').addClass('current');
          $(this).find('.tab-content').first().addClass('current');
        ...
        $('.widget-product-list .tabs-menu_btn').click(function(e){
          e.preventDefault();
          $('.widget-product-list .tabs-title').toggleClass("tabs-open");
        });
